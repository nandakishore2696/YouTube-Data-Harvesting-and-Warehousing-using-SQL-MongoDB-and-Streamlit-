...
try :
    if selected == 'Data Migration':
        ...
        with col2:
            ...
            st.write("UCHYVOFd3E5WfP5infRbuVtw")
            st.write("UCDybamfye5An6p-j1t2YMsg")
            st.write(" UCRqCK8izkO5xeVVtMKSHeRQ")
            st.write("UCq_njg0BL8sT3781M6IAfOg")
            st.write("UCJQJAI7IjbLcpsjWdSzYz0Q")

        # connecting to youtube api
        def connect_api():
            api_key = 'AIzaSyBoh3GP9gobnqSyKkAS9sH6jMVcI0tfE3s'
        ...
        myclient = pymongo.MongoClient("mongodb+srv://nandakishore2696:fprbEzfDdeHuWF5n@cluster0.fj5cb3y.mongodb.net/?retryWrites=true&w=majority")
        ...
        col1,col2 = st.columns([2,1])
        with col2:
            qs = st.radio('Pick your question to get the analysis',['1.What are the names of all the videos and their corresponding channels?'
